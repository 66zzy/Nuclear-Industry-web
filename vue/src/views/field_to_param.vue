    ...
    <div class="grid-stack">
        <div class="grid-stack-item" gs-id="graph3" gs-x="0" gs-y="0" :gs-w="width[0]" :gs-h="height[0]">
            <div class="grid-stack-item-content">
                <graph3 @zValueClicked="zValueClicked" :data="hist" :width="width[0]*80" :height="height[0]*80"/>
            </div>
        </div>
        <div class="grid-stack-item" gs-id="graph1" gs-x="4" gs-y="0" :gs-w="width[1]" :gs-h="width[1]">
            <div class="grid-stack-item-content">
                <graph1 :Mu_predict="Mu_predict" :width="width[1]*80" :height="height[1]*80"/>
            </div>
        </div>
        <div class="grid-stack-item" gs-id="graph2_choose" gs-x="0" gs-y="6" :gs-w="width[2]" :gs-h="width[2]">
            <div class="grid-stack-item-content">
                <graph2_choose :data="hist" :width="width[2]*80" :height="height[2]*80"/>
            </div>
        </div>
        <div class="grid-stack-item" gs-id="graph2" gs-x="4" gs-y="6" :gs-w="width[3]" :gs-h="width[3]">
            <div class="grid-stack-item-content">
                <graph2 :data="hist" :order="order" :width="width[3]*80" :height="height[3]*80"/>
            </div>
        </div>
